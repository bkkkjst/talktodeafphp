...
class ImageController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Image']))
		{
			...
			$image_name = $model->img_name;
			
			if ($image = CUploadedFile::getInstance ( $model, 'img_path' )) {
				// path for file upload
				$path = Yii::getPathOfAlias ( 'webroot' ) . '/images/';
				// use image name as username
				$filename = $image_name . '_image' . '.' . $image->getExtensionName ();
			...
			$model->img_datetime = date('Y-m-d H:i:s');
			if($model->save())
